...
async function procesarLoginStaff(event) {
    ...
    try {
        // 🔥 EL TRUCO DE RAÍZ: Cerramos cualquier sesión colgada en el navegador antes de firmar al staff
        await fisioNet.auth.signOut();
        localStorage.clear();
        sessionStorage.clear();

        // 1. Ahora sí logueamos limpio en Supabase
        ...
        // 4. Asentamiento en memoria local fresca

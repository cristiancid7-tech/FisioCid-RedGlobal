...
function switchLoginTab(rol) {
    ...
    if (rol === 'DOCTOR') {
        ...
        tabDoc.style.background = 'var(--primary)';
        tabDoc.style.color = 'white';
        tabPac.style.background = 'transparent';
        tabPac.style.color = 'var(--secondary)';
    } else {
        formDoc.style.display = 'none';
        formPac.style.display = 'block';
        tabDoc.style.background = 'transparent';
        tabDoc.style.color = 'var(--secondary)';
        tabPac.style.background = '#ecc94b';
        tabPac.style.color = '#1a202c';
    }
}
